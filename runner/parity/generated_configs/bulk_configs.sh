...
cat > ouroboros-node2/address << EOF
export ADDRESS="0x002e28950558fbede1a9675cb113f0bd20912019"
EOF
...
cat > ouroboros-node3/address << EOF
export ADDRESS="0x00a94ac799442fb13de8302026fd03068ba6a428"
EOF
